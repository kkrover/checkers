    ...
    <div className="container-fluid">
      ...
      <div className="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <ul className="nav navbar-nav navbar-right">
          ...
          <li><Link to="/checker"><i className="fa fa-question-circle-o fa-fw"></i> Checker</Link></li>
          <li><Link to="/player"><i className="fa fa-question-circle-o fa-fw"></i> Player</Link></li>
        </ul>
      </div>
    </div>
  </nav>
